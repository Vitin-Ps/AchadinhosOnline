...
const routes: Routes = [
  ...
  { path: '', component: HomeComponent },
  { path: 'funcionarios', component: CadFuncionarioComponent, canActivate: [RoleGuard], data: {expectedRole: 'ADMIN'}},
  { path: 'funcionarios/:id', component: EditFuncComponent, canActivate: [RoleGuard], data: {expectedRole: 'ADMIN'}},
  { path: 'produtos', component: CadProdutoComponent, canActivate: [RoleGuard], data: {expectedRole: 'ADMIN'}},
  { path: 'produtos/:id', component: EditProdComponent, canActivate: [RoleGuard], data: {expectedRole: 'ADMIN'}},
  { path: 'vendas', component: CadVendaComponent, canActivate: [RoleGuard], data: {expectedRole: 'FUNCIONARIO'}},
  { path: 'vendas/:id', component: CadVendaComponent, canActivate: [RoleGuard], data: {expectedRole: 'FUNCIONARIO'}},
  { path: 'vendas/edit/:id', component: EditVendaComponent, canActivate: [RoleGuard], data: {expectedRole: 'FUNCIONARIO'}},
  { path: 'sobre', component: SobreComponent },
  { path: 'carrinho-produtos/:id', component: CarrinhoProdutoComponent, canActivate: [RoleGuard], data: {expectedRole: 'ADMIN'}},
  {
