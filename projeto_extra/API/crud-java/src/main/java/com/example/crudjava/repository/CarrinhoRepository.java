...
public interface CarrinhoRepository extends JpaRepository<Carrinho, Long> {
    ...
    List<Carrinho> findAllByFuncionarioId(Long funcionarioId);

    void deleteAllByFuncionarioIdAndProdutoId(Long funcionarioId, Long produtoId);

    List<Carrinho> findAllByFuncionarioIdAndProdutoId(Long aLong, Long aLong1);
}
